...
public class MotorPowerGrapher extends JApplet implements KeyListener {
	...
	public void init() {
        ...
        double power = identifyNumberInString(pointInStringFormat, "Power: ");
	...
	public void paint(Graphics g) {
		super.paint(g);
		g.drawLine(0, yTranslate  +500-200, 100, yTranslate+500 -200);
